...
class ScoringResult(BaseModel):
    ...
    relevance_score: float = Field(
        ge=0,
        le=30,
        description="Relevance score 0-30 for Windsor.ai affiliate fit",
    )
    relevance_rationale: str = Field(
        description="1-2 sentences explaining why this channel fits Windsor.ai's affiliate program",
    )
